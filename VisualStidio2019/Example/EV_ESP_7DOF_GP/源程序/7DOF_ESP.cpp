...
#define state_dimension_gp 3 // 用于高斯回归的状态变量维度
...
//横摆角速度高斯过程回归模型初始化
	...
	V_yawrate = solve(L_a_yawrate_2D, ks_s_yawrate); //L_a_2D可能是转置，结果不对可以来这里看看
...
//质心侧偏角高斯过程回归模型初始化
	...
	V_slipangle = solve(L_a_slipangle_2D, ks_s_slipangle); //L_a_2D可能是转置，结果不对可以来这里看看
